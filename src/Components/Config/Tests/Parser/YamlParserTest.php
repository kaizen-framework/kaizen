...
use App\Components\Config\Tests\Fixtures\Schema\InvalidSchemaBuilder;
use App\Components\Config\Tests\Fixtures\Schema\SchemaBuilder;
...
class YamlParserTest extends TestCase
{
    ...
    {
        $schema = new InvalidSchemaBuilder();
